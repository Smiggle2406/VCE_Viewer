        ...
        try:
            ...
            def download_one(file_url):
                ...
                try:
                    ...
                    # Infer year/exam from filename; fix subject to dialog selection
...
class NoZoomPdfView(QPdfView):
    ...
    def wheelEvent(self, event: QWheelEvent):
        # Ignore scroll wheel for zooming, allow scrolling only
        event.ignore()
...
class VCEViewer(QMainWindow):
    def __init__(self):
        ...
        self.current_zoom = 1.0  # Track current zoom factor
